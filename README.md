...
• Created a Car_Age feature using the manufacturing year.
...
• Actual vs Predicted Price plot for Linear Regression
• Actual vs Predicted Price plot for Lasso Regression
...
1. Place the dataset file (car data.csv) in the project directory.
